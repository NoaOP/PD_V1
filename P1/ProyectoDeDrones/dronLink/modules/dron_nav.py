...
def changeNavSpeed (self, speed):
    ...
    if hasattr(self, 'direction') and self.direction != "Stop" and self.state == 'flying':
        # Solo si estaba moviéndose activamente, le volvemos a dar la orden con la nueva velocidad
        self.go(self.direction)
