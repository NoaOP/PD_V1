...
def orange ():
    global video_receiver
    video_receiver.setObject(49)

def cake ():
    global video_receiver
    video_receiver.setObject(55)
...
def crear_ventana():
    ...
    detectFrame.columnconfigure(5, weight=1)
    ...
    dogBtn = tk.Button(detectFrame, text="Perro", bg="dark orange", command=dog)
    dogBtn.grid(row=0, column=3, padx=5, pady=5, sticky=tk.N + tk.S + tk.E + tk.W)

    orangeBtn = tk.Button(detectFrame, text="Naranja", bg="dark orange", command=orange)
    orangeBtn.grid(row=0, column=4, padx=5, pady=5, sticky=tk.N + tk.S + tk.E + tk.W)

    cakeBtn = tk.Button(detectFrame, text="Pastel", bg="dark orange", command=cake)
    cakeBtn.grid(row=0, column=5, padx=5, pady=5, sticky=tk.N + tk.S + tk.E + tk.W)
